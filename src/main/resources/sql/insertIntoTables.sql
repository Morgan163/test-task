...
INSERT INTO RECIPES (id, patient_id, doctor_id, date_of_create, validity, priority)
 VALUES (NEXT VALUE FOR recipeSequence, 1,2,to_date('12/12/2016', 'DD/MM/YYYY'), 30, 'Нормальный');

INSERT INTO RECIPES (id, patient_id, doctor_id, date_of_create, validity, priority)
 VALUES (NEXT VALUE FOR recipeSequence, 2,3,to_date('24/04/2017', 'DD/MM/YYYY'), 60, 'Срочный');

INSERT INTO RECIPES (id, patient_id, doctor_id, date_of_create, validity, priority)
 VALUES (NEXT VALUE FOR recipeSequence, 3,1,to_date('07/05/2017', 'DD/MM/YYYY'), 15, 'Немедленный');